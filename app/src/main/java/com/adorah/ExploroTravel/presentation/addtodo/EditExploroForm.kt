...
fun EditExploroForm(
    ...
    var title by remember{ mutableStateOf(exploro.title) }
    var description by remember{ mutableStateOf(exploro.description) }
